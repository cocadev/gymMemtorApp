...
export default class ModalApparatusTutorial extends Component{
                    ...
                    <Grid >
                            ...
                            <Row size={8} style={{alignItems:"center", justifyContent:"center", flexDirection:"column" }}>
                                ...
                                <Button
                                    ...
                                    full rounded
                                    onPress={()=>{
                                        this.props.nextAction({currentModal:"APPARATUS_TUTORIAL",action:"WATCH",dismiss:this.state.dismissTutorial})
                                    }}>
                                ...
                                <Button
                                    ...
                                    full rounded
                                    onPress={()=>{
                                        this.props.nextAction({currentModal:"APPARATUS_TUTORIAL",action:"SKIP",dismiss:this.state.dismissTutorial})
                                    }}>
                                ...
                                <Text style={styles.modalSubText}>
                                    {"\n"}
                                    These can be found later in settings
                                </Text>
